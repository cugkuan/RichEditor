 ...
 * BirdCampus
 */
public class StrikeEditButton extends EditButton {

    public StrikeEditButton(ImageView textView, RichEditorBridge richEditor) {
    ...
    public void handle() {
        changeMark();
        mRichEditor.getRichEditor().setStrikeThrough();
    }
}
